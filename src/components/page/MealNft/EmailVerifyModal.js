...
export default function EmailVerifyModal({ open, setOpenEmail, otpVerify, setError, handleVerifyEmail }) {
            ...
            >
                <Box sx={style} id="">
                    ...
                    <div className='d-flex' style={{ justifyContent: 'center' }}>
                        <button type='submit' onClick={handleVerifyEmail} className='submit banner-button2 font14 text-decoration-none pb-2' id="font14">Resend OTP</button>
                    </div>
                </Box>
            </Modal>
        </div>
