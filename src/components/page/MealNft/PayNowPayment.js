    ...
    return (
        <div className=' ' style={{ backgroundColor: '#1A1A25' }}>
            ...
            <div className="companyDetails">
                ...
                <p className='text-center'><span className='text-primary'>Bill Reference No:</span> {email}</p>
            </div>
            ...
            <div className="buttonDiv">
                ...
                <p className='mb-3'><button className='paynowPaidButton' onClick={handleHome}>Home</button></p>
