      ...
      <div>
        <Container>
          ...
          <div className="text-white p-2">
            ...
            <Typography className="pt-2 howItWorksFs" variant="subtitle2" component="div">
            ...
            <Typography className="pt-2 pb-3 howItWorksFs" variant="subtitle2" component="div">
          ...
          <div className="text-white mt-3 p-2">
            ...
            <Typography className="pt-1 howItWorksFs" variant="subtitle2" component="div">
              3. 5 mins Live Performance by Celebrity
            </Typography>
            <Typography className="pt-1 howItWorksFs" variant="subtitle2" component="div">
