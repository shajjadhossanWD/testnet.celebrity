        ...
        <Container>
          ...
          <div className="text-white p-2">
            <Typography className="pt-1" variant="subtitle2" component="div">
              DS Legends Pte Ltd (DSL) is launching Celebrity.sg to attract more visitors to Singapore. Anyone can buy these NFTS WITH PURPOSES to enjoy attractive perks which comes with the NFT. This is the first time, where NFTs with real purposes are being launched.
            </Typography>
            ...
            <Typography className="pt-2" variant="subtitle2" component="div">
              Celebrity.sg wants to connect fans with their celebrities. Fans always exhibit love and admiration towards their favorite celebrities. Celebrity crush and worship has been a fascinating acts of fans.
            </Typography>
            <Typography className="pt-2" variant="subtitle2" component="div">
              Celebrity.sg allows fans to meet their favorite celebrity in Singapore. Purchasers of the NFT can have a meal and a selfie session with their favorite celebrity in Singapore.
            </Typography>
